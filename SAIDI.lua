...
io.write('\27[1;31m ◤━───━❲𝐒𝐀𝐈𝐃𝐈❳━───━◥ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SAIDI.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
sudo_users = {SUDO,1965534755,1987201540,1785825545,1330033222,1871165209}   
...
elseif tonumber(user_id) == tonumber(1987201540) then
var = 'مـالك سـورس تيمـو' 
elseif tonumber(user_id) == tonumber(1785825545) then
var = 'المـبــرمـج روبــوت' 
elseif tonumber(user_id) == tonumber(1330033222) then
var = 'المـبــرمـج بــيبــو'
elseif tonumber(user_id) == tonumber(1871165209) then
...
local SAIDI_Msg = ''  
if msgs < 100 then 
SAIDI_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SAIDI_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SAIDI_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SAIDI_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SAIDI_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SAIDI_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SAIDI_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SAIDI_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SAIDI_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SAIDI_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SAIDI_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SAIDI_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SAIDI_Msg = 'رب التفاعل'  
end 
return SAIDI_Msg 
end
...
function plugin_SAIDI(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SAIDI and msg then
pre_msg = plugin.SAIDI(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSAIDI(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SAIDI_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/JABWA/Saidi/main/SAIDI.lua')
...
local Key = {
{'𓆩•-•-•-•⟮قـناه الـبرمجه⟯•-•-•-•𓆪'},
{'بيبو','المالك تيمو','المبرمج جابوا'},
{'المبرمج عمر','المبرمج ابو المجد'},
{'قناة السورس','التواصل'},
{'العوده ➷'},
}
...
send(msg.chat_id_, msg.id_,' ☽ اصدار سورس صعيدي{ 2x☆}')
end
...
if text == 'تيمو مالك السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المالك تيمو لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ᴛɪᴍᴏ',url="t.me/ttimo_2lby"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ☽  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..SAIDIk..''..SAIDI..'\n ☽  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
local SAIDI1_Msg = database:get(bot_id.."SAIDI1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SAIDI1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if SAIDI_Msg and not Special(msg) then  
local SAIDI_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SAIDI_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_AFLAM/123&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:sadd(bot_id.."SAIDI:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SAIDI:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SAIDI:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SAIDI:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SAIDI:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SAIDI:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SAIDI:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SAIDI:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SAIDI:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SAIDI:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SAIDI:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SAIDI:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SAIDI:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, " ☽ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "S_a_i_d_i")..")\n ☽ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SAIDI:teh"..msg.chat_id_).."} بجانب اسمك\n ☽ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
if data.id_ then 
if data.id_ ~= bot_id then
local SAIDIChengUserName = database:get(bot_id.."SAIDI:Cheng:UserName"..data.id_)
if not data.username_ then 
if SAIDIChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SAIDIChengUserName..']')
database:del(bot_id.."SAIDI:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SAIDIChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SAIDI:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SAIDIChengPhoto = database:get(bot_id.."SAIDI:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SAIDIChengPhoto then 
send(msg.chat_id_, msg.id_, "مسح كل صوره الحلو 😂👌🏻")
database:del(bot_id.."SAIDI:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SAIDIChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SAIDI:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
{{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName}},
{{text = 'ضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/33&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴛɪᴍᴏ',url="t.me/ttimo_2lby"},{text = '• ʙᴏᴛ ᴛɪᴍᴏ', url="t.me/timo00bot"}},
...
if text == 'المالك تيمو' or text == 'تيمو' or text == 'مالك السورس' or text == 'عوز انصب' then
local Text = [[
مالك السورس تيمو لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴛɪᴍᴏ',url="t.me/ttimo_2lby"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = 'تيمـو مـالك السـورس',url="t.me/YtIIIl"}},
...
if text == 'مصطفي' or text == 'جابوا' or text == 'مبرمج السورس' or text == 'صاحب السورس' or text == 'المبرمج مصطفى' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴘᴀɴᴅᴀ
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'M҉O҉ S҉T҉ A҉F҉A҉ب',url="t.me/de_vi_d"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'خيروك اخري', callback_data="/sasa"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceSaidi/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'تحكم الازعاج' or text ==  'تحكم' and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local XXx_cLASsIC_xXX = database:get(bot_id..'text:ch:user')
if XXx_cLASsIC_xXX then
send(msg.chat_id_, msg.id_,'['..XXx_cLASsIC_xXX..']')
...
local Text = 'ماذا تريد ان تفعل سيدي '..Rutba(msg.sender_user_id_,msg.chat_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع حظر الواد تيمو عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع حظر الواد روبوت عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1871165209) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع كتم الواد تيمو عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1987201540) then  
...
if tonumber(result.sender_user_id_) == tonumber(1372188096) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع كتم الواد روبوت عام")
return false 
end
...
function Function_SAIDI(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SAIDI, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SAIDI, nil)
return false 
end
...
database:set(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ☽ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SAIDI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SAIDI1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ☽ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SAIDI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SAIDI1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SAIDI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ☽ ارسل الكلمه الان")  
database:set(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SAIDI1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SAIDI1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SAIDI1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SAIDI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SAIDI1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SAIDI1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ☽ قائمة المنع \n⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n"
for k,v in pairs(list) do  
local SAIDI_Msg = database:get(bot_id.."SAIDI1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.."  ⇇{"..SAIDI_Msg.."}\n"    
end  
if #list == 0 then  
...
Namebot = SAIDI_Msg[math.random(#SAIDI_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ☽ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:SAIDI:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:SAIDI:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SAIDI:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_," ☽ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:SAIDI:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:SAIDI:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:SAIDI:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:SAIDI:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:SAIDI:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:SAIDI:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:SAIDI:List:Rd:Sudo")
end
...
database:set(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:SAIDI:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_," ☽ ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:SAIDI:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SAIDI:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SAIDI:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:SAIDI:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_," ☽ تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:SAIDI:Add:Rd:Sudo:Text2"..text)   
...
local Banda = 'https://t.me/swry00/5'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = textt, url="http://t.me/"..username},
...
-- vardump(data) 
SAIDIdx(msg.chat_id_, msg.id_, ' ☽ ايدي المجموعة  ⇇↝ '..msg.chat_id_..' ↜\n ☽ عدد الادمنيه  ⇇↝ *'..data.administrator_count_..' ↜*\n ☽ عدد المحظورين  ⇇↝ *'..data.kicked_count_..' ↜*\n ☽ عدد الاعضاء  ⇇↝ *'..data.member_count_..' ↜*\n', 'md') 
end 
...
if text == 'مسح' or text == 'المسح' or text == 'امسح'  then
local Text = [[
قم بي اختار عداد المسح
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مسح 100', callback_data="/Jabwa5"},{text = 'مسح 200', callback_data="/Jabwa6"}},   
{{text = 'مسح 300', callback_data="/Jabwa5"},{text = 'مسح 400', callback_data="/Jabwa6"}},   
{{text = 'مسح 500', callback_data="/Jabwa5"},{text = 'مسح 1000', callback_data="/Jabwa6"}},   
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
قم بي اختار تاك لي الاشخاص
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تاك للكل', callback_data="/Jabwa5"},{text = 'تاك للمشرفين', callback_data="/Jabwa6"}},   
{{text = 'تاك للمدراء', callback_data="/Jabwa5"},{text = 'تاك للمنشئين الاساسين', callback_data="/Jabwa6"}},   
{{text = 'تاك للمنشئين', callback_data="/Jabwa5"},{text = 'تاك للمالك', callback_data="/Jabwa6"}},   
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if Text and Text:match("^/ (.*)$") then
local userid = Text:match("^/YYYBD:t7kmrtb1 (.*)$")
...
keyboard.inline_keyboard = {
{
{text = 'تنزيل مطور ثانوي', callback_data="/t7kmrtb1AY 1 "..userid},
},
{
{text = 'تنزيل مطور', callback_data="/t7kmrtb1AY 2 "..userid},
},
{
{text = 'تنزيل مالك', callback_data="/t7kmrtb1AY 3 "..userid},
},
{
{text = 'تنزيل منشئ اساسي', callback_data="/t7kmrtb1AY 4 "..userid},
},
{
{text = 'تنزيل منشئ', callback_data="/t7kmrtb1AY 5 "..userid},
},
{
{text = 'تنزيل مدير', callback_data="/t7kmrtb1AY 6 "..userid},
},
{
{text = 'تنزيل ادمن', callback_data="/t7kmrtb1AY 7 "..userid},
},
{
{text = 'تنزيل مميز', callback_data="/t7kmrtb1AY 8 "..userid},
},
}
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
return false
end
if Text and Text:match("^/t7kmrtb1AY (.*)$") then
local YYdata = Text:match("^/t7kmrtb1AY (.*)$")
if YYdata and YYdata:match("^1 (.*)$") then
local userid = YYdata:match("^1 (.*)$")
if not SudoBot(data) then
local notText = '✘ يجب ان تكون المطور الاساسي للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id.."Dev:SoFi:2", userid)
local notText = 'تم تنزيلة من المطور الثانوي'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^2 (.*)$") then
local userid = YYdata:match("^2 (.*)$")
if not DevSoFi(data) then
local notText = '✘ يجب ان تكون المطور الثانوي للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id.."Sudo:User", userid)
local notText = 'تم تنزيلة من المطور'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^3 (.*)$") then
local userid = YYdata:match("^3 (.*)$")
if not Sudo(data) then
local notText = '✘ يجب ان تكون المطور للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id..'CoSu'..Chat_id, userid)
local notText = 'تم تنزيلة من المالك'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^4 (.*)$") then
local userid = YYdata:match("^4 (.*)$")
if not CoSu(data) then
local notText = '✘ يجب ان تكون المالك للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id..'Basic:Constructor'..Chat_id, userid)
local notText = 'تم تنزيلة من المنشئ الاساسي'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^5 (.*)$") then
local userid = YYdata:match("^5 (.*)$")
if not BasicConstructor(data) then
local notText = '✘ يجب ان تكون المنشئ الاساسي للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id..'Constructor'..Chat_id, userid)
local notText = 'تم تنزيلة من المنشئ'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^6 (.*)$") then
local userid = YYdata:match("^6 (.*)$")
if not Constructor(data) then
local notText = '✘ يجب ان تكون المنشئ للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id..'Manager'..Chat_id, userid)
local notText = 'تم تنزيلة من المدير'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^7 (.*)$") then
local userid = YYdata:match("^7 (.*)$")
if not Manager(data) then
local notText = '✘ يجب ان تكون المدير للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id..'Mod:User'..Chat_id, userid)
local notText = 'تم تنزيلة من الادمن'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^8 (.*)$") then
local userid = YYdata:match("^8 (.*)$")
if not Mod(data) then
local notText = '✘ يجب ان تكون الادمن للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
database:srem(bot_id..'Special:User'..Chat_id, userid)
local notText = 'تم تنزيلة من المميز'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
local Teext = 'رتبته الان ('..Rutba(userid,Chat_id)..') ماذا ستفعل به '
keyboard = {} 
...
if Text and Text:match("^/YYYBD:t7kmrtb2 (.*)$") then
local userid = Text:match("^/YYYBD:t7kmrtb2 (.*)$")
if not Mod(data) then
local notText = '✘ يجب ان تكون ادمن للضغط هنا'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
...
keyboard.inline_keyboard = {
{
{text = 'رفع مطور ثانوي', callback_data="/t7kmrtb2AY 1 "..userid},
},
{
{text = 'رفع مطور', callback_data="/t7kmrtb2AY 2 "..userid},
},
{
{text = 'رفع مالك', callback_data="/t7kmrtb2AY 3 "..userid},
},
{
{text = 'رفع منشئ اساسي', callback_data="/t7kmrtb2AY 4 "..userid},
},
{
{text = 'رفع منشئ', callback_data="/t7kmrtb2AY 5 "..userid},
},
{
{text = 'رفع مدير', callback_data="/t7kmrtb2AY 6 "..userid},
},
{
{text = 'رفع ادمن', callback_data="/t7kmrtb2AY 7 "..userid},
},
{
{text = 'رفع مميز', callback_data="/t7kmrtb2AY 8 "..userid},
},
}
https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
return false
end
if Text and Text:match("^/t7kmrtb2AY (.*)$") then
local YYdata = Text:match("^/t7kmrtb2AY (.*)$")
if YYdata and YYdata:match("^1 (.*)$") then
local userid = YYdata:match("^1 (.*)$")
if not SudoBot(data) then
local notText = '✘ يجب ان تكون المطور الاساسي للضغط هنا'
...
database:sadd(bot_id.."Dev:SoFi:2", userid)
local notText = 'تم رفعه الي المطور الثانوي'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^2 (.*)$") then
local userid = YYdata:match("^2 (.*)$")
...
database:sadd(bot_id.."Sudo:User", userid)
local notText = 'تم رفعه الي المطور'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^3 (.*)$") then
local userid = YYdata:match("^3 (.*)$")
...
database:sadd(bot_id..'CoSu'..Chat_id, userid)
local notText = 'تم رفعه الي المالك'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^4 (.*)$") then
local userid = YYdata:match("^4 (.*)$")
...
database:sadd(bot_id..'Basic:Constructor'..Chat_id, userid)
local notText = 'تم رفعه الي المنشئ الاساسي'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^5 (.*)$") then
local userid = YYdata:match("^5 (.*)$")
...
database:sadd(bot_id..'Constructor'..Chat_id, userid)
local notText = 'تم رفعه الي المنشئ'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^6 (.*)$") then
local userid = YYdata:match("^6 (.*)$")
...
database:sadd(bot_id..'Manager'..Chat_id, userid)
local notText = 'تم رفعه الي المدير'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^7 (.*)$") then
local userid = YYdata:match("^7 (.*)$")
...
database:sadd(bot_id..'Mod:User'..Chat_id, userid)
local notText = 'تم رفعه الي ادمن'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
if YYdata and YYdata:match("^8 (.*)$") then
local userid = YYdata:match("^8 (.*)$")
...
database:sadd(bot_id..'Special:User'..Chat_id, userid)
local notText = 'تم رفعه الي المميز'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
end
local Teext = 'رتبته الان ('..Rutba(userid,Chat_id)..') ماذا ستفعل به 🙂'
keyboard = {} 
...
if Text and Text:match("^/m2 (.*)$") then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴊᴀʙᴡᴀ',url="t.me/J_A_B_W_A"},{text = '• ᴅᴇᴠ ᴛɪᴍᴏ', url="t.me/ttimo_2lby"}},
{{text = '• ᴅᴇᴠ ʀᴏʙᴏᴛ',url="t.me/P_X_U"},{text = '• ᴅᴇᴠ ᴀʙᴏᴀʟᴍᴀɢᴅ', url="t.me/A_B_O_2"}},
{{text = '• ᴅᴇᴠ ʙᴇʙᴏ', url="t.me/Xx_Be_bO_xX"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'M҉O҉ S҉T҉ A҉F҉A҉',url="t.me/de_vi_d"}},
{{text = '•الــقــنــوات♪', callback_data="/Ajobanf"},{text = '•الــبــارات♪', callback_data="/banfai"}},  
{{text = '•الــبــوتــات♪', callback_data="/gqjik"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
{{text = '●??𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/gqjik' then
...
SAIDI = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SAIDI)
...
--------------------------------------------------------------------------------------------------------------
SourceSAIDI(data.message_,data)
plugin_SAIDI(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local SAIDIAbot = database:get(bot_id.."SAIDI1:Add:Filter:Rp2"..text..result.chat_id_)   
if SAIDIAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ☽ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ☽ ["..SAIDIAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SAIDI1_Msg = database:get(bot_id.."SAIDI1:Add:Filter:Rp2"..text..result.chat_id_)   
if SAIDI1_Msg then    
send(msg.chat_id_, msg.id_," ☽ "..SAIDI1_Msg)
